...
function getFriendFuture(name) {
    ...
    const futurePredictions = {
        ...
        rajdip:"In the not-so-distant future, Rajdip became the ultimate ladies' man, surrounded by an entourage of adoring fans. His charm reached such legendary heights that he had his own personal fan club with fan-made hashtags like #RajdipCharms and #LadiesManRaj. His calendar was filled with social events, but the highlight was always the 'Rajdip Gala,' an exclusive soirée where he dazzled everyone with his infectious laughter and playful antics.",
